...
% Outputs
% -------
%    feat:     WT features organized as [Energy, Variance, Waveform Length]
...
J=1;% Number of decomposition levels which can also be set using
...
feat =([log1p([tab_ENER tab_VAR  tab_WL])]);