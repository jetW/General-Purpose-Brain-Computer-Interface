...
right_processed=load('2(with3sSegmentation)/rightBandpass0190Nothch4852');
left_processed=load('2(with3sSegmentation)/leftBandpass0190Nothch4852');
...
right_C4_features=zeros(127,4500);
right_C3_features=zeros(127,4500);
left_C4_features=zeros(127,4500);
left_C3_features=zeros(127,4500);
